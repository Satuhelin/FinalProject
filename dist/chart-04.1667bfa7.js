...
var xPositionScale = d3.scaleLinear().domain([0, 68]).range([0, width]);
var yPositionScale = d3.scaleBand().domain(['W.BUSH', 'OBAMA', 'TRUMP']).range([height, 0]).padding(0.5);
...
function ready(datapoints) {
  ...
  }).attr('height', yPositionScale.bandwidth()).attr('x', 0).attr('y', function (d) {
    return yPositionScale(d.President);
  }).attr('fill', 'red');
...
},{"d3":"../node_modules/d3/index.js","../data/visitscount1.csv":"data/visitscount1.csv"}]},{},["scripts/chart-04.js"], null)
